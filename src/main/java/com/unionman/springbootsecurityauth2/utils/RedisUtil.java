...
public class RedisUtil {
    ...
    public static void main(String[] args) {
        ...
        //jedis.flushAll();
        //SystemData.out.println("Connection to server sucessfully");
        //查看服务是否运行
        //SystemData.out.println("Server is running: "+jedis.ping());
        jedis.close();
        /*RedisUtil redisUtil = new RedisUtil();
        List<Object> list = redisUtil.lGet("41d2e941-11dd-4795-8628-831eb95236ce",0,1);
        SystemData.out.println(list);*/
    }
